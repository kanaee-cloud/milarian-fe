...
export const LandingLayout = () => {
    return (
        <div className="relative min-h-screen overflow-hidden bg-dark text-white">
            ...
            <div className="aurora absolute right-14 top-96   w-[500px] h-[500px] bg-gradient-to-tr from-accent via-cyan-400 to-purple-400 rounded-full blur-2xl opacity-25 animate-aurora3" />
            <div className="aurora absolute left-14 top-[162vh]   w-[500px] h-[500px] bg-gradient-to-tr from-accent via-cyan-400 to-purple-400 rounded-full blur-2xl opacity-25 animate-aurora3" />
